...
export default function Footer() {
  ...
  return (
  <SlideSection index={8} dockBottom className="flex flex-col items-center justify-between gap-2 border-t-4 border-[#5a64ff] bg-[#271B4C] px-4 py-3 text-white sm:flex-row sm:px-6">
        <motion.span
